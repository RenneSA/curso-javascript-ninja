...
*/
 var myarra2 = [ninja, 52.4, true,[1,2,'Daciuk'],{b:2}]

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
console.log(myfunction2(myarra2,0));
console.log(myfunction2(myarra2,1));
console.log(myfunction2(myarra2,2));
console.log(myfunction2(myarra2,3));
console.log(myfunction2(myarra2,4));
